...
var Collin = NinjaConstructor("Collin", 25, "Test Analyst");
Collin.introduce = function(){
    console.log(`${Michael.name} you lie! My name is ${Collin.name} and I am the Sensei`)
} 
Collin.introduce();
